 ...
 * whitespace.
 */
public class GhsDemanglerParser {
	...
	*/
	 ...
	 */
	public List<DemangledParameter> parseParameters(String parameterString) {
	 ...
	 */
	public DemangledType convertToNamespaces(List<String> names) {
		if (names.size() == 0) {
			return null;
		}
